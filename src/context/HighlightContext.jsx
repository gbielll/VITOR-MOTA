...
const HighlightContext = createContext();  /*essa variável chama a funcão createContext, o contexto posso especificar de maneira global*/
...
export function useHighlight(){
    ...
    const {highlight,setHighlight}=context; //destruturar esse obj, pois ele recebe do useContext(HighlightContext), atrves do value o :highlight,setHighlight
    return {highlight,setHighlight}; //retornando apos destruturar
}